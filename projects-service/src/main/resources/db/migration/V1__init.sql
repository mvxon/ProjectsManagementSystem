...
ALTER TABLE IF EXISTS tasks_statuses
    ADD CONSTRAINT tasks_statuses_fk FOREIGN KEY (task_id) REFERENCES tasks;
ALTER TABLE IF EXISTS projects_statuses
    ADD CONSTRAINT projects_statuses_fk FOREIGN KEY (project_id) REFERENCES projects;