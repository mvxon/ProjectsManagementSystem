...
VALUES (1, 'Formation of requirements',
       ...
       (6, 'Formation of requirements',
        'Get project requirements from the customer, discuss them with the employees team', 'DEVELOPING', 2, '2022-07-05',
        '2022-08-05'),
       (7, 'Design', 'Perform design, selection of technologies and workers for project implementation', 'DEVELOPING', 2,
        '2022-07-05', '2022-09-05'),
       (8, 'Implementation', 'Implement the project according to all requirements and design', 'DEVELOPING', 2, '2022-07-05',
        '2022-10-09'),
       (9, 'Testing', 'Test all implemented functionality and check compliance with customer requirements', 'OPEN', 2,
        '2022-07-05', '2022-11-05'),
       (10, 'Introduction', 'Present and implement the developed software', 'DEVELOPING', 2, '2022-07-05', '2022-12-20'),

       (11, 'Formation of requirements',
        'Get project requirements from the customer, discuss them with the employees team', 'OPEN', 3, '2022-07-05',
        '2022-08-05'),
